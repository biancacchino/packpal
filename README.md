...
Packpal is a collaborative packing-list app prototype built from a Next.js starter.

This repository contains a small Next.js + Drizzle starter adapted to Packpal's needs (auth, simple DB helpers and pages). The original starter README is preserved below for reference.

---

# Next.js + PostgreSQL Auth Starter (original template)
